...
prompt_setter() {
  ...
  then PS1="($(clock_prompt))${yellow} ["$CONDA_DEFAULT_ENV"] ${reset_color}${blue}\u${reset_color}@${green}\H${reset_color} ${yellow}\w${reset_color}$(scm_prompt_info) ${reset_color}$(prompt_end) "
    else PS1="($(clock_prompt)) ${blue}\u${reset_color}@${green}\H${reset_color} ${yellow}\w${reset_color}$(scm_prompt_info) ${reset_color}$(prompt_end) "
  fi
